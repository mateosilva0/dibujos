...
function updateCanvas() { background("white"); random_number = Math.floor((Math.random() * quick_draw_data_set.length) + 1); console.log(quick_draw_data_set[random_number]); sketch = quick_draw_data_set[random_number];
 document.getElementById('sketch_name').innerHTML = 'Dibujo a ser trazado: ' + sketch; }
function preload() {
...
function gotResult(error, results) {
  ...
  console.log(results);
  document.getElementById('label').innerHTML = 'tu dibujo: ' + results[0].label;
